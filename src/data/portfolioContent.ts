...
export const FLAGSHIP_PROJECTS: FlagshipProject[] = [
  {
    ...
    architectureNodes: [
      { id: "ast", label: "AST Parser & Call Graph", sublabel: "Tree-sitter repository indexing", type: "input" },
      { id: "cwe", label: "CWE Vulnerability Gate", sublabel: "Security rule matching", type: "process" },
      { id: "slm", label: "Local Quantized SLM", sublabel: "Targeted candidate patch synthesis", type: "process" },
      { id: "verifier", label: "Static AST Verifier", sublabel: "Syntax & contract validation", type: "decision" },
      { id: "sandbox", label: "Docker Isolation Sandbox", sublabel: "Compilation & regression test execution", type: "decision" },
      { id: "gate", label: "Human Approval Gate", sublabel: "Cryptographic patch diff output", type: "output" },
    ],
    build: {
  ...
  },
  {
    ...
    architectureNodes: [
      { id: "mic", label: "Microphone Stream", sublabel: "16kHz 16-bit PCM audio stream", type: "input" },
      { id: "vad", label: "Energy VAD & Ring Buffer", sublabel: "Voice activity detection & chunking", type: "process" },
      { id: "mel", label: "Mel-Spectrogram Engine", sublabel: "Hardware-accelerated FFT processing", type: "process" },
      { id: "enc", label: "Quantized Encoder", sublabel: "4-bit / 8-bit hybrid transformer weights", type: "process" },
      { id: "stream", label: "Streaming CTC Decoder", sublabel: "Greedy search with language priors", type: "decision" },
      { id: "out", label: "Text Normalizer", sublabel: "Inverse text normalization & punctuation", type: "output" },
    ],
    build: {
  ...
  },
  {
    ...
    architectureNodes: [
      { id: "imu", label: "MPU6500 6-DOF IMU", sublabel: "Raw 3-axis gyro + 3-axis accel at 500Hz", type: "input" },
      { id: "filter", label: "Chebyshev Low-Pass Filter", sublabel: "40Hz digital vibration attenuation", type: "process" },
      { id: "kalman", label: "Kalman State Estimator", sublabel: "Attitude matrix & gyro bias tracking", type: "process" },
      { id: "pid", label: "Dual PID Control Loop", sublabel: "Roll & pitch rate control", type: "decision" },
      { id: "pwm", label: "PWM Servo Mixer", sublabel: "Elevon deflection commands", type: "output" },
      { id: "airframe", label: "Physical Aircraft Dynamics", sublabel: "Aerodynamic corrective forces ↺", type: "output" },
    ],
    build: {
